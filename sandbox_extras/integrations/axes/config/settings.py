"""
Django settings for axes integration testing.

Tests django-axes lockout integration with auth_kit login views.
"""
...
AXES_COOLOFF_TIME = None  # No cooloff for testing (permanent lockout until reset)
